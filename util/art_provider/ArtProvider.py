...
class ArtProvider:
    ...
    def get_album_art(
        self, artist_name: str, track_title: str = None, album_title: str = None
    ) -> ImageSet:
        ...
        if not album_art:
            ...
            if not album_art:
                ...
                album_art = itunes_store.get_album_art(
    ...
    def get_scrobble_images(
        self, artist_name: str, track_title: str, album_title: str = None
    ) -> ScrobbleImages:
        """Get Spotify artist images and album art"""

        # 1. Try getting artist images and album art from Spotify
        spotify_data = self.spotify_api.get_track_images(
            artist_name, track_title, album_title
        )
    ...
    def __get_lastfm_album_art(self, artist_name: str, album_title: str) -> ImageSet:
        ...
        if " - Single" in album_title:
            album_info = self.lastfm.get_album_info(
                artist_name, album_title.replace(" - Single", "")
            )
